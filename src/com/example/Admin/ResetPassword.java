...
public class ResetPassword extends JPanel{
	...
	String userName;
	//(Notice)nicer 2 babei userName Forgotpassword teke ResetPassword e patano kora jai...(ami korci 1No. ta)
	//1.ForgotPassword teke userName patabe ResetPassword e String diye receive korbe......
	//2.sessionbean diyeo kora jai.tar jonno sessionbean class e 2ta mathod kora lagbe a)getForgotuserName() b)setForgotuserName()
	...
	public boolean resetPassword(){
		try {
			String sql="update tbnewuserinfo set pass='"+txtConfirampass.getText().toString().trim()+"' "
